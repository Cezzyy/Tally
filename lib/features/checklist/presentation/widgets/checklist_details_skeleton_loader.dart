...
class ChecklistDetailsSkeletonLoader extends StatelessWidget {
  const ChecklistDetailsSkeletonLoader({super.key});
  ...
  Widget _buildHeaderLoader(BuildContext context) {
    return Column(
      ...
      children: [
        // Title
        SkeletonText(
          width: context.isMobile ? 220 : 350,
          height: context.isMobile ? 24 : (context.isTablet ? 28 : 32),
        ),
        const SizedBox(height: 8),
        SkeletonText(
          width: context.isMobile ? 160 : 250,
          height: context.isMobile ? 24 : (context.isTablet ? 28 : 32),
        ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SkeletonText(height: 14),
              const SizedBox(height: 8),
              SkeletonText(width: context.isMobile ? 180 : 280, height: 14),
            ],
          ),
        ),
      ],
  ...
  Widget _buildItemsLoader(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
